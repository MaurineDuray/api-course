...
#[ApiResource(
    ...
    normalizationContext: [
        ...
        // du coup on enlève les typages de type float et date des variables
    ]
)]
...
class Invoice
{
    ...
    #[Assert\Type(type:"numeric", message:"Le format du montant doit être numérique")]
    private $amount = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE)]
    #[Groups(['invoices_read','customers_read','invoices_subresource'])]
    #[Assert\NotBlank(message:"LA dat de la facture est obligatoire")]
    ...
    #[Assert\Choice(choices:['SENT','PAID','CANCELLED'], message: "Le statut doit être soit PAID, soit SENT soit CANCELLED")]
    ...
    #[Assert\Type(type:"numeric", message:'Le chrono de la facture doit être un format numérique')]
    private $chrono = null;
